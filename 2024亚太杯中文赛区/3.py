...
w = [w11, w12, w13, w21, w22, w23, w31, w32, w33, w11, w12, w13, w21, w22, w23, w31, w32, w33,
...
a1_, a2_, a3_, b1_, b2_, b3_, c1_, c2_, c3_ = (Binary('a1_'), Binary('a2_'), Binary('a3_'), Binary('b1_'),
                                               Binary('b2_'), Binary('b3_'), Binary('c1_'), Binary('c2_'), Binary('c3_'))
...
x = [a1, a2, a3, b1, b2, b3, c1, c2, c3, a1_, a2_, a3_, b1_, b2_, b3_, c1_,
     c2_, c3_, d1, d2, d3, e1, e2, e3, f1, f2, f3]
x_ = ['a1', 'a2', 'a3', 'b1', 'b2', 'b3', 'c1', 'c2', 'c3', 'a1_', 'a2_', 'a3_', 'b1_', 'b2_', 'b3_',
      'c1_', 'c2_', 'c3_', 'd1', 'd2', 'd3', 'e1', 'e2', 'e3', 'f1', 'f2', 'f3']
# 定义罚函数
...
H1 = P1 * (14 - 12 * (a1 + a2 + a3 + a1_ + a2_ + a3_) - 5 * (d1 + d2 + d3)) ** 2
H2 = P2 * (24 - 12 * (b1 + b2 + b3 + b1_ + b2_ + b3_) - 5 * (e1 + e2 + e3)) ** 2
H3 = P3 * (18 - 12 * (c1 + c2 + c3 + c1_ + c2_ + c3_) - 5 * (f1 + f2 + f3)) ** 2
H4 = P4 * (27 - 12 * (a1 + a1_ + b1 + b1_ + c1 + c1_) - 5 * (d1 + e1 + f1)) ** 2
H5 = P5 * (10 - 12 * (a2 + b2 + c2 + a2_ + b2_ + c2_) - 5 * (d2 + e2 + c2)) ** 2
H6 = P6 * (19 - 12 * (a3 + b3 + c3 + a3_ + b3_ + c3_) - 5 * (d3 + e3 + c3)) ** 2
