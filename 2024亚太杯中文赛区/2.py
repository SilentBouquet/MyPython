...
H1 = P1 * (19 - 12 * (a1 + a2 + a3 + a1_ + a2_ + a3_) - 5 * (d1 + d2 + d3)) ** 2
H2 = P2 * (20 - 12 * (b1 + b2 + b3 + b1_ + b2_ + b3_) - 5 * (e1 + e2 + e3)) ** 2
H3 = P3 * (12 - 12 * (c1 + c2 + c3 + c1_ + c2_ + c3_) - 5 * (f1 + f2 + f3)) ** 2
H4 = P4 * (19 - 12 * (a1 + a1_ + b1 + b1_ + c1 + c1_) - 5 * (d1 + e1 + f1)) ** 2
H5 = P5 * (25 - 12 * (a2 + b2 + c2 + a2_ + b2_ + c2_) - 5 * (d2 + e2 + c2)) ** 2
H6 = P6 * (7 - 12 * (a3 + b3 + c3 + a3_ + b3_ + c3_) - 5 * (d3 + e3 + c3)) ** 2
